...
const ar: LangStrings = {
  ...
  about: {
    ...
    chapters: [
      ...
      },
      {
        eyebrow: 'II',
        title: 'الإدراك',
        body: 'معظم الشركات لا تفشل بسبب السوق؛ تفشل لأن المؤسس توقّف عن الرؤية بوضوح. أنا توقّفتُ. نقاط العمى لم تكن في الجداول — بل كانت فيّ.',
      },
      {
        eyebrow: 'III',
        title: 'ميلاد خبير الفشل',
        body: 'عدتُ إلى كل انهيار — انهياري وانهيارات مئات غيري. قرأتُ التشريحات، وجلستُ مع المؤسسين.. ورصدتُ الأنماط التي لم يُرِد أحدٌ تسميتها. خبير الفشل هو ما خرج من تلك الهواجس: منهجية، لا علامة تجارية.',
      },
      {
        eyebrow: 'IV',
        title: 'العمل',
        body: 'أدرس سيكولوجية المؤسسين الذين انكسروا؛ التشوهات المعرفية، حلقات الإنكار، والقرارات التي بدت منطقية في حينها وانفجرت بعد 18 شهراً. هذا ليس تدريباً؛ هذا تحليل جنائي للإنسان داخل الشركة.',
      },
    ],
    quoteOpen: '"',
    ...
    pillars: [
      {
        n: '01',
        k: 'بلا مشايخ مصطنعين',
        v: 'لا مسرح تحفيزي، ولا تنظير كليشيهات LinkedIn. البيانات وحدها قاسية بما يكفي.',
      },
      {
        n: '02',
        k: 'سيكولوجية المؤسس',
        v: 'لكل انهيار توقيعه البشري الخالص؛ نتتبّع مسار القرار حتى نصل إلى الحالة المعرفية التي أنتجته.',
      },
      {
        n: '03',
        k: 'ذكاء الأنماط',
        v: 'مئات التشريحات المترابطة والمقارنة.. الأنماط تتكرر دائماً، ونحن نسمّيها قبل أن تتكرر فيك.',
      },
    ],
    closingBody: 'إن وصلتَ إلى هنا.. فشيء ما في شركتك لا يبدو صحيحاً بالفعل.',
    closingSub: 'ثق بهذا الإحساس الباطني. معظم المؤسسين يصلون إليّ متأخرين 6 أشهر.. لا تكن أحدهم.',
    ctaButton: 'اطلب تشريحاً لشركتك الآن',
    caseSnippets: [
  ...
  valley: {
    ...
    heroHeading2: 'الموت',
    heroSub:
      'بلا تحفيز، وبلا تجميل. أجب بصدق؛ فالشخص الوحيد الذي تملك رفاهية الكذب عليه هنا.. هو أنت.',
    lore: {
      eyebrow: '',
    ...
    narrative: {
      ...
      intro: 'اصطلح المستثمرون على تسمية الفجوة بين بناء المنتج وتحقيق الإيراد المستدام بـ "وادي الموت"—وهي المقبرة التي تختفي فيها معظم الشركات الناشئة.',
      heading: 'المشكلة؟ أن معظم المؤسسين لا يرون الوادي.. إلا حين يصبحون في قاعه.',
      p1: 'وادي الموت هو الفجوة الصامتة بين احتراق آخر شعلة من إنكارك الذاتي، وأول دولار حقيقي من الإيراد. هنا يتقلّص النقد، ويقرأ فريقك تعابير وجهك، وتكفّ جداول البيانات عن الكذب.',
      p2: 'فالشركات لا تموت بسبب ظروف السوق؛ بل تموت داخل الوادي لأن المؤسس استمر في تمثيل الثقة بينما الأرض تنهار تحته.',
      p3: 'بُني هذا التشخيص بناءً على تحليل جنائي لمئات الانهيارات، ورصد الأنماط الإدراكية المشوهة التي يظهرها المؤسسون قبل الكارثة بأشهر.',
      p4: 'لا توجد إجابات صحيحة هنا..\nهناك فقط ما ستعترف به لنفسك أخيراً.',
    },
    diagnosisCta: {
      intro: 'هذا ليس استبياناً تقليدياً. إنه تشخيص نفسي منضبط، مصمَّم بدقة لانتزاع ما تعجز عن قوله بصوتٍ عالٍ—عن شركتك، فريقك، ونفسك.',
      timeNote: 'المدة: 4 دقائق من المواجهة.',
      privacyNote: 'الخصوصية: التشريح سري وخاص تماماً؛ أنت وحدك من سيرى النتيجة.',
      button: 'ابدأ تشخيص نقاط عماك الآن',
    },
    curve: {
      eyebrow: '',
      heading1: 'كل شركة ناشئة تسير',
      heading2: 'على المنحنى نفسه.',
      sub: 'الفرق الوحيد: من يعبر إلى الضفة الأخرى، ومن يختفي في القاع.',
      stages: [
      ...
      captions: [
        ...
        { t: '03 · الصعود', b: 'إن نجوت ووصلت إلى هنا، فالإيراد بدأ يغطي حرق السيولة. الشركة تحولت إلى حقيقة مستدامة.' },
      ],
    },
  ...
  contact: {
    ...
    eyebrow: 'جلسة مغلقة',
    heroHeading1: 'طلب حجز:',
    heroHeading2: 'جلسة المخاطر والمواجهة',
    heroSub:
      'بلا تفاؤل مصطنع، وبلا كليشيهات وردية. محادثة مغلقة وصادقة بحجم الحقيقة، تفكك قراراتك والمخاطر الصامتة التي تتحرك تحت شركتك الآن.',
    heroArabicSub: 'خطوة واحدة قد تغير مسار شركتك.',
    pillars: [
      { k: 'سرية مطلقة',     v: 'لا شيء يخرج من الغرفة، ولا ملاحظات يجري تشاركها مع أي جهة؛ السرية محمية قانونياً وأخلاقياً.' },
      { k: 'مواجهة مباشرة',  v: 'سأضع إصبعي على جروح شركتك، وأخبرك بما يعجز فريقك ومستشاروك عن قوله في وجهك.' },
      { k: 'الحقيقة العارية', v: 'بلا كليشيهات، وبلا مسرحيات تحفيزية سطحيّة؛ فقط البيانات والحقائق القاسية على الطاولة.' },
    ],
    formLabel:   'بوابة التشريح الجنائي',
    formHeading: 'أخبرني بما يحدث خلف الكواليس فعلاً.',
    fieldName:   'الاسم الكامل',
    fieldNamePlaceholder: 'محمد خليل',
    fieldEmail:  'البريد الإلكتروني الرسمي للعمل (Corporate Email)',
    fieldEmailPlaceholder: 'you@company.com',
    fieldCompany: 'اسم الشركة / المشروع (اختياري - محمي بالسرية)',
    fieldCompanyPlaceholder: 'الاسم أو سري',
    fieldStage:  'ما هي المرحلة الحالية للمشروع؟ (اختر خياراً واحداً)',
    fieldStageDefault: '',
    stages: [
      { v: 'idea',         label: 'فكرة أو مرحلة ما قبل البناء (Pre-MVP)' },
      { v: 'pre-seed',     label: 'ما قبل التمويل الأولي (Pre-Seed)' },
      { v: 'seed',         label: 'جولة التمويل الأولي (Seed)' },
      { v: 'series-a',     label: 'الجولة (A) وما بعدها (Series A+)' },
      { v: 'post-failure', label: 'ما بعد الانهيار / مرحلة التحول المحوري (Pivot)' },
    ],
    fieldContext: 'شخّص العرض الأبرز الآن: (يمكنك اختيار أكثر من بند)',
    fieldContextPlaceholder:
      'الأرقام تقول شيئاً. حدسي يقول شيئاً آخر. نحن...',
    fieldContextHint: 'كن حاداً ومباشراً؛ فكلما كان مدخلك أصدق عرياً، كانت خطة الإنقاذ أسرع وأحدّ.',
    submitLabel:    'تقدّم بطلب حجز الجلسة المغلقة',
    submittingLabel: 'جاري الإرسال…',
    submitDisclaimer:
      'ملاحظة حاسمة: إرسال هذه البيانات لا يضمن قبول الجلسة تلقائياً. أقبل عدداً محدوداً وصارماً من الحالات الحرجة شهرياً بناءً على مستوى التوافق والجدية.',
    successHeading: 'تم استلام طلبك.',
    successBody:
      'أقرأ كل طلب بنفسي. إن ناسبتك الجلسة، ستسمع مني مباشرة.',
    closingQuote: '"أنقذها الآن.. قبل أن تتحول شركتك إلى مجرد دراسة حالة فشل أخرى على الإنترنت."',
    sessionInfo: 'جلسة تشخيص خاصة · 60 دقيقة · تركيز كامل على تفكيك أخطر أنماط الفشل في شركتك.',
    situationTagsLabel: 'وصف سريع للوضع (اختياري — اختر ما ينطبق)',
    situationTags: [
      'خلافات صامتة أو معلنة بين الشركاء المؤسسين',
      'معدل حرق نقدي حاد (Burn Rate) يهدد التمويل',
      'غياب أو تراجع التوافق مع السوق (Product-Market Fit)',
      'تعثر جولات التمويل أو جفاف السيولة القادمة',
      'تفكك أو انهيار العقد البشري للفريق القيادي',
      'نمو وهمي في الأرقام والمؤشرات بلا إيرادات حقيقية',
      'أعراض أخرى..',
    ],
