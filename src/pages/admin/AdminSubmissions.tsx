...
function getRiskMeta(t: ReturnType<typeof useAdminLanguage>['t']): Record<
  string,
...
> {
  return {
    ...
    'INSIDE THE VALLEY': {
      label: t.risk['INSIDE THE VALLEY'],
    ...
    'COLLAPSE PROXIMITY': {
      label: t.risk['COLLAPSE PROXIMITY'],
      color: 'text-crimson',
      bg:    'bg-crimson/10',
